...
st.set_page_config(page_title="Example Stock Predictor", layout="wide")
with st.sidebar:
    st.title("Example Stock Predictor")
    ticker = st.text_input("Enter a Stock Predictor  (e.g. CMI)", "CMI")
    ...
    if not ticker.strip():
        ...
        try:
            with st.spinner('Please wait...'):
                ...
                #Since not every stock has business metrics
